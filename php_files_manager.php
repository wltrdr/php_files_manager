		...
		if(isset($_POST['token'])) {
			...
			if($tree_only === false) {
				...
				foreach($elems_dirs as $elem_dir) {
					...
					$elements .= "<a class=\"$link_icon\" onmousedown=\"startLongClic()\" onmouseup=\"endClicDir(this, '$full_path_enc', '$el_html', '$el_enc', $link_js)\" oncontextmenu=\"menuDir('$el_html', '$cur_enc', '$el_enc', '$full_path_enc', $web_url, $link_js)\" ondragover=\"dragOverAdir(this, '$full_path_enc')\" ondragleave=\"dragLeaveAdir(this)\" ondrop=\"dropOnAdir(this)\"><span class=\"icon\"></span><span class=\"txt\">$el_html</span></a>\n";
				}
				...
				if(isset($elems_files)) {
					foreach($elems_files as $elem_file) {
						...
						$elements .= "<a class=\"$link_icon\" onmousedown=\"startLongClic()\" onmouseup=\"endClicFile(this, '$el_html', '$cur_enc', '$el_enc', $web_url, $link_js)\" oncontextmenu=\"menuFile('$el_html', '$cur_enc', '$el_enc', $web_url, $link_js)\"><span class=\"icon\"></span><span class=\"txt\">$el_html</span><span class=\"size\">" . size_of_file($elem_file['size']) . '</span><span class="date">' . date('d/m/Y H:i:s', $elem_file['time']) . "</span></a>\n";
					}
				}
